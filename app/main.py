...
# The SPA frontend always lives on a different origin from this API (the
# Vite dev server on :5173 in local dev; a static host/CDN in production),
# so it needs CORS explicitly — see Settings.cors_allow_origins.
app.add_middleware(
    CORSMiddleware,
